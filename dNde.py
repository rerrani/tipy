...
################# 
################# (i)   The initial dN/de is parametrised through E+21 Eq. 13, has a 
#################       power-law slope towards the most-bound energies, and an exponential
#################       truncation beyond some scale energy
################# (ii)  We use E+21 Eq. 9 to compute the selection of particles in the 
...
# see E+21 Eq. 13, Fig. 10 and Fig. C1
alpha = 3.
beta  = 3.
es    = 10**-0.32
...
# Relaxation process
# energies mapped through E+21 Eq. 12
...
# (c) final   dN/de : energies refer to the final (exponentially truncated cusp) minimum, related to the final mass through E+21 Eq. 11 
